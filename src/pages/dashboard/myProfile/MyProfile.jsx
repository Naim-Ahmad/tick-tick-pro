...
import { Avatar, Box, Button, ButtonGroup, Card, CardActions, CardContent, Chip, IconButton, SvgIcon, Typography } from '@mui/material';
...
export default function MyProfile() {
  ...
  return (
    <Box display="flex" justifyContent="center" alignItems="center" minHeight="100svh">
      <Card
      sx={{
        width: 320,
        maxWidth: '100%',
    ...
    >
      <CardContent  sx={{ alignItems: 'center',  textAlign: 'center' }}>
        <Avatar style={{margin: 'auto'}} src={user ? user?.photoURL : "/static/images/avatar/1.jpg"} sx={{ '--Avatar-size': '4rem' }} />
        <Chip
          size="sm"
          variant="filled"
          color="primary"
        ...
        <Typography variant="body1" fontWeight="bold">{user?.displayName}</Typography>
